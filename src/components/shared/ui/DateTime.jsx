...
export default function DateTime({ label, dumper, setDumper }) {
    ...
    return (
        <div className='flex border-2 border-sky-900 bg-sky-100 text-2xl rounded-md overflow-hidden'>
            ...
            <input type="datetime-local" className='text-sky-800 bg-sky-100' value={dumper[label] || ''} onChange={changeHandler} />
        </div>
    )
}